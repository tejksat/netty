...
public final class AsciiString extends ByteString implements CharSequence, Comparable<CharSequence> {
    ...
    private static final NativeTypeTranslator CASE_INSENSITIVE_TRANSLATOR = new NativeTypeTranslator() {
        @Override
        public long translate(long value) {
            return (long) toLowerCase((byte) value) |
                   ((long) toLowerCase((byte) (value >>> 8)) << 8) |
                   ((long) toLowerCase((byte) (value >>> 16)) << 16) |
                   ((long) toLowerCase((byte) (value >>> 24)) << 24) |
                   ((long) toLowerCase((byte) (value >>> 32)) << 32) |
                   ((long) toLowerCase((byte) (value >>> 40)) << 40) |
                   ((long) toLowerCase((byte) (value >>> 48)) << 48) |
                   ((long) toLowerCase((byte) (value >>> 56)) << 56);
        }

        @Override
        public int translate(int value) {
            return toLowerCase((byte) value) |
                   (toLowerCase((byte) (value >>> 8)) << 8) |
                   (toLowerCase((byte) (value >>> 16)) << 16) |
                   (toLowerCase((byte) (value >>> 24)) << 24);
        }

        @Override
        public char translate(char value) {
            return (char) (toLowerCase((byte) value) |
                          (toLowerCase((byte) (value >>> 8)) << 8));
        }
    ...
    private static final HashCodeGenerator CASE_INSENSITIVE_HASHER =
            PlatformDependent.newHashCodeGenerator(CASE_INSENSITIVE_TRANSLATOR);
    ...
    public static int caseInsensitiveHashCode(CharSequence value) {
        if (value instanceof AsciiString) {
            // TODO: is it worth AsciiString caching a case insensitive hash code value?
            AsciiString ascii = (AsciiString) value;
            return CASE_INSENSITIVE_HASHER.hashCode(
                        ascii.array(), ascii.arrayOffset(), ascii.arrayOffset() + ascii.length(), HASH_CODE_SEED);
        }

        return CASE_INSENSITIVE_HASHER.hashCodeAsBytes(value, 0, value.length(), HASH_CODE_SEED);
    }
