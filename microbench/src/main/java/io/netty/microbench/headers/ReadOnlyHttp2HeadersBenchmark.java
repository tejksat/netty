...
public class ReadOnlyHttp2HeadersBenchmark extends AbstractMicrobenchmark {
    AsciiString[] headerNames;
    AsciiString[] headerValues;
    ...
    public int readOnlyTrailers() {
        return iterate(ReadOnlyHttp2Headers.trailers(buildPairs(), false));
    }
    ...
    public int readOnlyClientHeaders() {
        return iterate(ReadOnlyHttp2Headers.clientHeaders(HttpMethod.POST.asciiName(), path, HttpScheme.HTTPS.name(),
                                                          authority, buildPairs(), false));
    }
    ...
    public int readOnlyServerHeaders() {
        return iterate(ReadOnlyHttp2Headers.serverHeaders(HttpResponseStatus.OK.codeAsText(), buildPairs(), false));
    }
